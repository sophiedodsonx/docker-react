Created a workflow that uses Docker to author and publish applications, GitHub to deploy code into TravisCI and integrated with AWS Elastic Beanstalk to host the website
